...
public:
    ...
    void insertColor(const QColor &col, int index);
    void exec();
...
void QtColorPicker::buttonPressed(bool toggled)
{
    ...
    QColor col = QColorDialog::getColor(QColor(255,100,200,255));
    if (!col.isValid())
    return;
...
void QtColorPicker::setColor()
{
    const QColorDialog::ColorDialogOptions options = QFlag(QColorDialog::ColorDialogOptions::enum_type::DontUseNativeDialog);
    const QColor color = QColorDialog::getColor(Qt::green, this, "Select Color", options);


}

void QtColorPicker::defaultColor()
{
    popup->insertColor(Qt::black, 0);
    popup->insertColor(Qt::white,  1);
    popup->insertColor(Qt::red,  2);
    popup->insertColor(Qt::darkRed,  3);
    popup->insertColor(Qt::green,4);
    popup->insertColor(Qt::darkGreen, 5);
    popup->insertColor(Qt::blue, 6);
    popup->insertColor(Qt::darkBlue,  7);
    popup->insertColor(Qt::cyan,  8);
    popup->insertColor(Qt::darkCyan,  9);
    popup->insertColor(Qt::magenta,  10);
    popup->insertColor(Qt::darkMagenta,  11);
    popup->insertColor(Qt::yellow,  12);
    popup->insertColor(Qt::darkYellow,  13);
    popup->insertColor(Qt::gray,  14);
    popup->insertColor(Qt::darkGray,  15);
    popup->insertColor(Qt::lightGray,  16);
...
{
    insertColor(Qt::black);
    insertColor(Qt::white);
    insertColor(Qt::red);
    insertColor(Qt::darkRed);
    insertColor(Qt::green);
    insertColor(Qt::darkGreen);
    insertColor(Qt::blue);
    insertColor(Qt::darkBlue);
    insertColor(Qt::cyan);
    insertColor(Qt::darkCyan);
    insertColor(Qt::magenta);
    insertColor(Qt::darkMagenta);
    insertColor(Qt::yellow);
    insertColor(Qt::darkYellow);
    insertColor(Qt::gray);
    insertColor(Qt::darkGray);
    insertColor(Qt::lightGray);
}
...
/*! \internal
    ...
    bottom-right.
*/
void ColorPickerPopup::insertColor(const QColor &col, int index)
{
    ...
    ColorPickerItem *item = new ColorPickerItem(col,  this);
...
*/
ColorPickerItem::ColorPickerItem(const QColor &color,
				     QWidget *parent)
    : QFrame(parent), c(color),  sel(false)
{
    setToolTip(t);
    setFixedWidth(24);
    setFixedHeight(21);
